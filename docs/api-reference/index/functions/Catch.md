...
Defined in: [packages/core/src/exceptions/catch.decorator.ts:33](https://github.com/kiyasov/nestelia/blob/main/packages/core/src/exceptions/catch.decorator.ts#L33)
