...
Defined in: [packages/core/src/guards/use-guards.decorator.ts:13](https://github.com/kiyasov/nestelia/blob/main/packages/core/src/guards/use-guards.decorator.ts#L13)
