...
Defined in: [packages/cache/src/interfaces/cache-manager.interface.ts:31](https://github.com/kiyasov/nestelia/blob/main/packages/cache/src/interfaces/cache-manager.interface.ts#L31)
