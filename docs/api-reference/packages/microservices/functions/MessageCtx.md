...
Defined in: [packages/microservices/decorators/ctx.decorator.ts:17](https://github.com/kiyasov/nestelia/blob/main/packages/microservices/decorators/ctx.decorator.ts#L17)
