...
| Class | Description |
| ------ | ------ |
| [Test](classes/Test.mdx) | Test utilities for creating testing modules. |
| [TestingModule](classes/TestingModule.mdx) | Compiled testing module with methods to access providers |
| [TestingModuleBuilder](classes/TestingModuleBuilder.mdx) | Builder for creating and configuring testing modules. |

## Interfaces

| Interface | Description |
| ------ | ------ |
| [OverridesMetadata](interfaces/OverridesMetadata.mdx) | Metadata for provider overrides in testing module |
